<x-admin.table>
    ...
    <x-slot name="thead">
        <tr role="row">
            ...
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 30%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">Category Name
            </th>
        ...
        <tr class="filter">
            ...
            <th>
                <select class="form-control form-control-sm form-filter kt-input" wire:model.defer="searchCategory"
    ...
    <x-slot name="tbody">
        @forelse($sub_categories as $category)
            <tr role="row" class="odd">
                ...
                <x-admin.td-action>
                    <a class="dropdown-item" href="{{ route('sub-categories.edit', ['sub_category' => $category->id]) }}"><i
    ...
    <x-slot name="showingEntries">
        Showing {{ $sub_categories->firstitem() }} to {{ $sub_categories->lastitem() }} of {{ $sub_categories->total() }} entries
    </x-slot>
</x-admin.table>
