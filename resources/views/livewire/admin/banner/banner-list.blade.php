    ...
    <x-slot name="thead">
        <tr role="row">
        	<th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 30%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">Page Name
            </th>
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 30%;"
        ...
        @forelse($banners as $banner)
            <tr role="row" class="odd">
                ...
                <td class="align-center"><span
                        class="kt-badge  kt-badge--{{ $banner->active == 1 ? 'success' : 'warning' }} kt-badge--inline kt-badge--pill cursor-pointer"
                        wire:click="changeStatusConfirm({{ $banner->id }})">{{ $banner->active == 1 ? 'Active' : 'Inactive' }}</span>
                </td>
                <x-admin.td-action>
