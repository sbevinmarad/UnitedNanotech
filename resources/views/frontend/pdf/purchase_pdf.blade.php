...
<body>
 ...
 <div style="padding-bottom: 20px; background: #272928;"><img style="display: block;margin-left: auto;margin-right: auto;" src="{{asset('storage/app/public/'.@$setting->logo) }}" alt="logo"></div>
  ...
  <tr style="background-color: #d9d9d9;">
    ...
    <td style="font-size: 20px;font-family: arial;color: #000;padding-top: 5px;padding-bottom: 5px;padding-left: 13px;"> <strong>{{$order->customer_name}}</strong></td>
       <td style="font-size: 20px;font-family: arial;color: #000;padding-top: 5px;padding-bottom: 5px;padding-left: 13px;"><strong>{{$order->address}}, {{$order->city}}, {{$order->country->country_name}}</strong></td>
  ...
  <tr style="background-color: #d9d9d9;">
    ...
    <td style="font-size: 15px; font-family: arial; color: #000; background-color: #d9d9d9; padding-bottom: 5px;padding-left: 13px; padding-top: 5px;">Moble No: {{$order->customer_phone}}</td>
     <td style="font-size: 15px; font-family: arial; color: #000; background-color: #d9d9d9; padding-bottom: 5px;padding-left: 13px; padding-top: 5px;">Postcode: <span>{{$order->pin_code}}</span></td>
...
@endif
  ...
  <tr style="background-color: #f2f2f2;">
    ...
    <td style="font-size: 17px;font-family: arial;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 13px; background-color: #222;"><b>{{env('CURRENCY')}}{{number_format((($sub_total+$order->tax+$order->shipping_charge)),2)}}</b></td>
  </tr> 
</tbody></table>
