<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
	    ...
	    <x-admin.form-group>
	        ...
	        <x-admin.input type="text" wire:model.defer="price" placeholder="Price"  />
	    ...
	    <x-admin.form-group>
	        ...
	        <x-admin.filepond wire:model="image"
                    ...
                    maxFileSize="10mb"/>
            @if($price_plan->image)
            	<img src="{{asset('storage/app/public/'.$price_plan->image) }}" style="width: 150px; height:100px;display: inline-block ;" />
            @endif
